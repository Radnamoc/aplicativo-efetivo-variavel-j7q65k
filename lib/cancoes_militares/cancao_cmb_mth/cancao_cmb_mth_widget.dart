...
import 'cancao_cmb_mth_model.dart';
export 'cancao_cmb_mth_model.dart';

class CancaoCmbMthWidget extends StatefulWidget {
  const CancaoCmbMthWidget({super.key});

  @override
  State<CancaoCmbMthWidget> createState() => _CancaoCmbMthWidgetState();
}

class _CancaoCmbMthWidgetState extends State<CancaoCmbMthWidget>
    with TickerProviderStateMixin {
  late CancaoCmbMthModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CancaoCmbMthModel());
          ...
          body: Stack(
            children: [
                          ...
                          children: [
                            Align(
                              ...
                              child: TabBar(
                                ...
                                tabs: [
                                  Tab(
                                    text: 'Canção do Combatente de Montanha',
                                  ),
                                ],
              ...
              FlutterFlowYoutubePlayer(
                url: 'https://www.youtube.com/watch?v=hjPTjDySwPI',
                autoPlay: false,
                looping: true,
                mute: false,
                showControls: true,
